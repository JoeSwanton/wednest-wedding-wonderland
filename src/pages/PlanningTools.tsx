      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="tools-grid">
            ...
            <div className="bg-theme-cream border border-theme-beige rounded-lg p-8 text-center">
              <h2 className="text-3xl font-serif text-theme-brown mb-4">
                Ready to Take Your Wedding Planning to the Next Level?
              </h2>
              <p className="text-theme-brown-light max-w-2xl mx-auto mb-8">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6">
                <Button className="bg-theme-brown hover:bg-theme-brown-dark text-white font-medium px-8 py-3">
                  Create Free Account
                </Button>
                <Button 
                  variant="outline" 
                  className="border-theme-brown text-theme-brown hover:bg-theme-brown hover:text-white font-medium px-8 py-3"
                >
                  Learn More
                </Button>
              </div>
