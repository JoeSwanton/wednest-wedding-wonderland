    ...
    <footer className="w-full bg-wednest-cream py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-cormorant font-semibold text-wednest-brown mb-4">WedNest</h3>
        ...
        <div className="border-t border-wednest-beige mt-8 pt-8 text-center">
          <p className="text-sm text-wednest-brown-light">
            © {new Date().getFullYear()} WedNest. All rights reserved. Australia's premier wedding planning platform.
          </p>
        </div>
      </div>
    </footer>
