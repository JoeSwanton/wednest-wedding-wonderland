  ...
  return <div className="space-y-6">
      ...
      <form onSubmit={handleSignIn} className="space-y-4">
        <div className="space-y-2">
          ...
          <Input id="email" type="email" placeholder="your.email@example.com" value={email} onChange={e => setEmail(e.target.value)} className="w-full" required />
        </div>
        ...
        <Button type="submit" disabled={loading} className="w-full bg-wednest-sage hover:bg-wednest-sage-dark text-white bg-theme-brown">
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600">
            ...
            <button type="button" onClick={onSwitchToSignUp} className="text-wednest-sage hover:text-wednest-sage-dark font-medium">
              Create an account
            </button>
          </p>
        </div>
