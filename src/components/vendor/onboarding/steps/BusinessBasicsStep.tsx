...
const BUSINESS_CATEGORIES = [
  ...
  { value: "dresses", label: "Wedding Dresses" },
  { value: "suits", label: "Suits & Attire" },
...
const BusinessBasicsStep = ({ onNext, formData, updateFormData }: BusinessBasicsStepProps) => {
  const { user } = useAuth();
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (data?.publicUrl) {
        setLocalFormData(prev => ({ ...prev, logoUrl: data.publicUrl }));
        toast({
          title: "Logo uploaded",
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select 
            value={localFormData.businessCategory} 
        ...
        <div className="space-y-2">
          ...
          <Input
            id="abn"
            name="abn"
            value={localFormData.abn}
            onChange={handleChange}
            placeholder="E.g. 12 345 678 901"
          />
          <p className="text-xs text-wednest-brown-light">
            Providing an ABN helps verify your business and increases trust with customers.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            type="number"
            min="0"
            value={localFormData.yearsInBusiness}
            onChange={handleChange}
            placeholder="E.g. 5"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4">
            {localFormData.logoUrl ? (
              <div className="relative w-24 h-24 rounded-md overflow-hidden border border-wednest-beige">
                <img 
                  src={localFormData.logoUrl} 
                  alt="Business Logo" 
                  className="object-cover w-full h-full"
                />
                <button
                  type="button"
                  onClick={() => setLocalFormData(prev => ({ ...prev, logoUrl: "" }))}
              ...
              <div className="w-24 h-24 bg-gray-100 rounded-md flex flex-col items-center justify-center border border-dashed border-wednest-beige">
