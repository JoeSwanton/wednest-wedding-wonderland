...
const BusinessDescriptionStep = ({
  ...
  const handleAddSpecialty = () => {
    ...
    const updatedSpecialties = [...localFormData.specialties, specialtyInput.trim()];
    setLocalFormData(prev => ({
      ...prev,
      specialties: updatedSpecialties
    }));
    // Update parent form data immediately when adding specialties
    updateFormData({ specialties: updatedSpecialties });
    setSpecialtyInput("");
  };
  
  const handleRemoveSpecialty = (specialty: string) => {
    const updatedSpecialties = localFormData.specialties.filter(item => item !== specialty);
    setLocalFormData(prev => ({
      ...prev,
      specialties: updatedSpecialties
    }));
    // Update parent form data immediately when removing specialties
    updateFormData({ specialties: updatedSpecialties });
  };
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            maxLength={500}
            onBlur={() => updateFormData({ bio: localFormData.bio })}
          />
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            maxLength={100}
            onBlur={() => updateFormData({ tagline: localFormData.tagline })}
          />
